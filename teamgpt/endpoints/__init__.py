...
from teamgpt.endpoints.midjourney_proxy import router as midjourney_proxy_router
...
from teamgpt.endpoints.ws import router as ws_router
...
router.include_router(midjourney_proxy_router)
